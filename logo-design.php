...
<head>
    ...
    <title>Custom Logo Design Services - <?php echo SITE_NAME; ?></title>
    <meta name="description" content="<?php echo SITE_NAME; ?> offers professional logo design services tailored to your brand's identity. Get a custom logo that sets you apart!">
    <meta name="keywords" content="logo design, custom logo, professional logo design, branding, <?php echo SITE_NAME; ?>">
    ...
    <div class="th-hero-wrapper hero-4" id="hero">
        ...
        <div class="container">
            <div class="hero-style4">
                ...
                <span class="hero-subtitle">Logo Design Service</span>
                <h1 class="hero-title">Logo Design</h1>
                <h2>That Speaks About Your Brand</h2>
                <p class="hero-text">
                    A logo is not just a symbol, it's the cornerstone of your brand's identity. We understand the power of a well-designed logo in establishing brand recognition and trust. Our designers and strategists are skilled in leveraging both design expertise and psychological insights to create logos that resonate deeply with your target audience.
                </p>
                <div class="btn-group">
            ...
            <div class="row">
                <div class="col-xl-4">
                    <div class="title-area mb-50 text-center text-md-start">
                        ...
                        <h2 class="sec-title">Shaping Brands for Success</h2>
                        <p class="section-text">
                            Step into our logo design showcase, where each creation is a testament to our commitment to shaping brand identities. From sleek and minimalist to bold and vibrant, our portfolio reflects the diverse personalities of the brands we've had the privilege to collaborate with.
                        </p>
                        <p class="section-text">
                            Let's shape your brand identity together and make your brand shine in the digital world.
                        </p>
                    </div>
            ...
            <div class="row align-items-center flex-row-reverse">
                ...
                <div class="col-xl-6">
                    <div class="title-area mb-35">
                        ...
                        <h2 class="sec-title">Softianz Begin The <span class="text-theme">Logo Design Excellence</span></h2>
                    </div>
                    <p class="mt-n2 mb-30 section-text">
                        We offer more than just logo design – we offer a collaborative journey where your vision meets our expertise. With a team of skilled designers and strategists, we bring a unique blend of creativity and strategic thinking to every project.
                    </p>
                    <?php /*
    ...
    <section class="space">
        <div class="container th-container5">
            <div class="title-area text-center">
                ...
                <p class="section-text">
                    Is your brand ready to stand out? Check out our logo design pricings and choose the package that suits you best! With a range of prices, you can find the perfect fit for any budget. Unleash your potential, contact us now and see how we can help!
                </p>
            </div>
