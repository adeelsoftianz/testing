  ...
  */
  ...
  /*---------- 01. On Load Function ----------*/
   ...
   $(window).scroll(function () {
    ...
    var $validation =
        '[name="name"],[name="email"],[name="service"],[name="number"],[name="message"]'; // Must be use (,) without any space
    ...
    var GetAQuoteForm = ".get_a_quote_form";
    $(GetAQuoteForm).on("submit", function (element) {
        element.preventDefault();
        //alert("Form In");
        var formData = $(GetAQuoteForm).serialize();
        jQuery.ajax({
                    url: "mail.php",
                    data: formData,
                    type: "POST",
    ...
    /*----------- Contact Us Form contact-us.php ----------*/
    ...
    /*----------- Contact Us Form contact-us.php (END) ----------*/
