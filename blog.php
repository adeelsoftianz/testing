...
<head>
    ...
    <title>Contact Us - Softianz</title>
                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="th-blog blog-single has-post-thumbnail">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a class="author" href="blog.php"><img src="assets/img/blog/author-1-1.png" alt="avater"> By Themeholy</a>
                                <a href="blog.php"><i class="fa-light fa-calendar-days"></i>21 June, 2024</a>
                                <a href="blog-details.php"><i class="fa-regular fa-comments"></i>Comments (3)</a>
                            </div>
                            <h2 class="blog-title"><a href="blog-details.php">Unsatiable entreaties may collecting Power.</a>
                            </h2>
                            ...
                            <a href="blog-details.php" class="line-btn">Read More</a>
                        </div>
                    </div>
                    ...
                    <div class="th-blog blog-single has-post-thumbnail">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a class="author" href="blog.php"><img src="assets/img/blog/author-1-1.png" alt="avater"> By Themeholy</a>
                                <a href="blog.php"><i class="fa-light fa-calendar-days"></i>22 June, 2024</a>
                                <a href="blog-details.php"><i class="fa-regular fa-comments"></i>Comments (3)</a>
                            </div>
                            <h2 class="blog-title"><a href="blog-details.php">Regional Manager limited time management.</a>
                            </h2>
                            <p class="blog-text">Progressively plagiarize quality metrics for impactful data. Assertively. Holisticly leverage existing magnetic functionalities. Assertively orchestrate high-quality customer service vis-a-vis intuitive interfaces. Conveniently enhance highly efficient infomediaries.</p>
                            <a href="blog-details.php" class="line-btn">Read More</a>
                        </div>
                    ...
                    <div class="th-blog blog-single">
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a class="author" href="blog.php"><img src="assets/img/blog/author-1-1.png" alt="avater"> By Themeholy</a>
                                <a href="blog.php"><i class="fa-light fa-calendar-days"></i>24 June, 2024</a>
                                <a href="blog-details.php"><i class="fa-regular fa-comments"></i>Comments (3)</a>
                            </div>
                            <h2 class="blog-title"><a href="blog-details.php">What’s the Holding Back It Solution Industry?</a>
                            </h2>
                            <p class="blog-text">Progressively plagiarize quality metrics for impactful data. Assertively. Holisticly leverage existing magnetic functionalities. Assertively orchestrate high-quality customer service vis-a-vis intuitive interfaces. Conveniently enhance highly efficient infomediaries.</p>
                            <a href="blog-details.php" class="line-btn">Read More</a>
                        </div>
                    ...
                    <div class="th-blog blog-single has-post-thumbnail">
                        ...
                        <div class="blog-content">
                            ...
                            <h2 class="blog-title"><a href="blog-details.php">Latin derived from Cicero's 1st-century BC</a>
                            </h2>
                            <p class="blog-text">Progressively plagiarize quality metrics for impactful data. Assertively. Holisticly leverage existing magnetic functionalities. Assertively orchestrate high-quality customer service vis-a-vis intuitive interfaces. Conveniently enhance highly efficient infomediaries.</p>
                            <a href="blog-details.php" class="line-btn">Read More</a>
                        </div>
                    ...
                    <div class="th-blog blog-single has-post-thumbnail">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a class="author" href="blog.php"><img src="assets/img/blog/author-1-1.png" alt="avater"> By Themeholy</a>
                                <a href="blog.php"><i class="fa-light fa-calendar-days"></i>25 June, 2024</a>
                                <a href="blog-details.php"><i class="fa-regular fa-comments"></i>Comments (3)</a>
                            </div>
                            <h2 class="blog-title"><a href="blog-details.php">Regional Manager limited time management.</a>
                            </h2>
                ...
                <div class="col-xxl-4 col-lg-5">
                    <aside class="sidebar-area">
                        ...
                        <div class="widget widget_categories  ">
                            ...
                            <ul>
                                <li>
                                    <a href="blog.php">IT Solution</a>
                                </li>
                                <li>
                                    <a href="blog.php">SEO Marketing</a>
                                </li>
                                <li>
                                    <a href="blog.php">Web Development</a>
                                </li>
                                <li>
                                    <a href="blog.php">Cloud Solution</a>
                                </li>
                                <li>
                                    <a href="blog.php">Network Marketing</a>
                                </li>
                                <li>
                        ...
                        <div class="widget  ">
                            ...
                            <div class="recent-post-wrap">
                                ...
                                <div class="recent-post">
                                    ...
                                    <div class="media-body">
                                        <h4 class="post-title"><a class="text-inherit" href="blog-details.php">What’s the Holding Back It Solution Industry?</a></h4>
                                        <div class="recent-post-meta">
                        ...
                        <div class="widget widget_tag_cloud   ">
                            ...
                            <div class="tagcloud">
                                ...
                                <a href="blog.php">Advice</a>
                                <a href="blog.php">Solution</a>
                                <a href="blog.php">Consultion</a>
                                <a href="blog.php">Business</a>
                                <a href="blog.php">Services</a>
                                <a href="blog.php">Start Up</a>
                                <a href="blog.php">Agency</a>
                                <a href="blog.php">Software</a>
                            </div>
                        </div>
                    </aside>
                </div>
