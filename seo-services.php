...
<head>
    ...
    <title>Top-notch SEO Services - <?php echo SITE_NAME; ?></title>
    <meta name="description" content="<?php echo SITE_NAME; ?> offers comprehensive SEO services to help your website rank higher on search engines and attract more organic traffic. Boost your online visibility with our proven SEO strategies!">
    <meta name="keywords" content="SEO services, search engine optimization, SEO solutions, website ranking, organic traffic, <?php echo SITE_NAME; ?>">
    ...
    <div class="th-hero-wrapper hero-4" id="hero">
        ...
        <div class="container">
            <div class="hero-style4">
                ...
                <span class="hero-subtitle">SEO Services</span>
                <h1 class="hero-title">Search Engine Optimization</h1>
                <h2>Boost Your Online Presence</h2>
                <p class="hero-text">
                    SEO isn't just about ranking higher on search engines, it's about making your brand stand out, attract the right audience, and drive meaningful results. At Softianz, we dive deep into your business goals, target audience, and industry standards to build a SEO strategy that ensures your website's ranking in search engines. <br>From keyword optimization and content strategy to technical SEO audits and link building, we leave no stone unturned to boost your online visibility and skyrocket your organic traffic.
                </p>
                <p class="hero-text">
            ...
            <div class="row">
                <div class="col-xl-4">
                    <div class="title-area mb-50 text-center text-md-start">
                        ...
                        <h2 class="sec-title">Stay Ahead of the Curve with SEO</h2>
                        <p class="section-text">
                            In today's digital age, SEO is more than just a strategy, it's an important tool for businesses to enhance their visibility, attract the audience, and outshine competitors.
                        </p>
                        <p class="section-text">
                            By choosing Softianz as your SEO partner, get ready to experience an increase in leads, conversions, and revenue, propelling your business to the new heights of success.
                        </p>
                    </div>
            ...
            <div class="row align-items-center flex-row-reverse">
                ...
                <div class="col-xl-6">
                    <div class="title-area mb-35">
                        ...
                        <h2 class="sec-title">Stay Ahead of the Curve with Strategic <span class="text-theme">SEO Solutions</span></h2>
                    </div>
                    <p class="mt-n2 mb-30 section-text">
                         We don't just optimize websites; we unlock opportunities, drive growth, and propel businesses to new heights of success. Our team of SEO experts dives deep into your industry, competitors, and target audience to craft a tailored strategy that delivers tangible results. From boosting your online visibility to increasing leads and revenue, we are committed to helping you achieve your digital goals. Choose Softianz for interactive SEO solutions that fuel your online growth and leave a lasting impact on your business.
                    </p>
                    <?php /*
    ...
    <section class="space">
        <div class="container th-container5">
            <div class="title-area text-center">
                ...
                <p class="section-text">
                    Is your brand ready to stand out? Check out our SEO services pricings and choose the package that suits you best! With a range of prices, you can find the perfect fit for any budget. Unleash your potential, contact us now and see how we can help!
                </p>
            </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="price-box th-ani ">
                        ...
                        <div class="price-box_content">
                            ...
                            <a href="contact-us.php" class="th-btn btn-fw style-radius" data-bs-toggle="modal" data-bs-target="#modalContactForm">
                                Choose Plan
                            </a>
                        </div>
                    </div>
